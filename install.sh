...
BREW_PACKAGES=(neovim tmux starship ripgrep fd fzf bat zoxide btop tldr gh lazygit stylua node go ruby vscode-langservers-extracted tailwindcss-language-server lua-language-server bash-language-server zsh-autosuggestions zsh-syntax-highlighting)
